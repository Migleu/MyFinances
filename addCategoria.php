                    ...
                    <div class="card-body">
                        <form action="acoes.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="decimal" name="nomeCategoria" id="nomeCategoria" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="add_categoria" class="btn btn-primary float-end">Adicionar</button>
                            </div>
                        </form>
                    </div>
                </div>
